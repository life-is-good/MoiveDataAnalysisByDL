...
def train_conv_net(datasets,
    ...
    parameters = [("input shape",img_h,img_w),("filter shape",filter_shapes), ("hidden_units",hidden_units),
...
#     word_vectors = "-word2vec"
    ...
    r = range(0,1)
    for i in r:
        datasets = make_idx_data_cv(revs, word_idx_map, i, max_l=56,k=100, filter_h=5)
